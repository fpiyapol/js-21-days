(()=> {
    ...
    function craeteSnawBalls(canvas, numberOfSnawBalls) {
       return [...Array(numberOfSnawBalls)].map(() => {
           return {
    ...
    function run() {
        const { canvas, canvasContext, numberOfSnawBalls} = setup()
        const snowBalls = craeteSnawBalls(canvas, numberOfSnawBalls)
        setInterval(() => {
